...
/**
 * Configure the PG Pool using the existing DATABASE_URL
 */
...
if (process.env.NODE_ENV === 'production') {
  ...
  prisma = new PrismaClient({ ...prismaOptions, adapter });
} else {
  if (!global.prisma) {
    // Pass the adapter to the constructor in development as well
    global.prisma = new PrismaClient({ ...prismaOptions, adapter });
  }
